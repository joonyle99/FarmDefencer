...
public abstract class ParabolicProjectile : ProjectileBase
{
    ...
    protected override void Move()
    {
        ...
        Vector2 pos = Vector2.Lerp(startPos, target.TargetPoint.position, linearT) + Vector2.up * height;
    ...
    protected override void Rotate()
    {
        ...
        Vector2 nextPos = Vector2.Lerp(startPos, target.TargetPoint.position, nextLinearT) + Vector2.up * nextHeight;
